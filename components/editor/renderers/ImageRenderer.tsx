...
import { ImageCropperDialog } from "../../foundation/forms/ImageCropperDialog";
  ...
  return (
    <div className="mx-5" {...attributes}>
      ...
      >
        ...
        <Tippy content={t("editor:insert-paragraph")}>
          <IconButton
            className={classNames(
        ...
        <Tippy content={t("editor:insert-paragraph")} placement="bottom">
          <IconButton
            className={classNames(
